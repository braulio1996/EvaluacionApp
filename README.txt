...
a persistence unit "EvaluacionWSCastroBraulioPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "EvaluacionWSCastroBraulio\pom.xml":
...
artifact ("EvaluacionWSCastroBraulio.war") is already built. You can build
